...
<body>
        ...
        <div class="flex gap-5 relative">
            <div class="sidebar bg-blue-900 w-1/5 h-screen  py-10 text-center rounded flex flex-col gap-7">
                <div class="icon flex gap-5 justify-center">
                    ...
                    <p class="my-3 font-bold text-yellow-100"><a href="/afficherClients.php">Clients</a></p>
                </div>
                <div class="icon flex gap-5 justify-center">
                ...
                <div class="icon flex gap-5 justify-center">
                    ...
                    <p class="my-3 font-bold text-yellow-100"><a href="/afficherContrats.php">Contrats</a></p>
                </div>
            </div>
            <div class="absolute top-10 left-[270px]">
            ...
            <div class="clients pt-32 w-full pr-5 top-4">
                ...
                <table class="table-auto border-collapse border border-gray-500 w-full">
                    <tr>
                        <th class=" py-2 px-2 text-left bg-blue-300">Num client</th>
                        <th class=" py-2 px-5 text-left bg-blue-300">Nom</th>
                        <th class=" py-2 px-2 text-left bg-blue-300">Adresse</th>
                        <th class=" py-2 px-4 text-left bg-blue-300">Téléphone</th>
    ...
    <!-- contrats -->
    <!-- <div class="clients pt-32 w-full pr-5">
        <p class="text-center py-5 font-bold text-3xl">Liste des contrats</p>
        <table class="table-auto border-collapse border border-gray-500 w-full">
            <tr>
                <th class=" py-2 px-2 text-left bg-blue-300">Num Contrat</th>
                <th class=" py-2 px-5 text-left bg-blue-300">Date début</th>
                <th class=" py-2 px-2 text-left bg-blue-300">Date Fin</th>
                <th class=" py-2 px-4 text-left bg-blue-300">Durée</th>
                <th class=" py-2 px-4 text-left bg-blue-300">Num Client</th>
                <th class=" py-2 px-4 text-left bg-blue-300">Num Immatriculation</th>
                <th class=" py-2 px-4 text-left bg-blue-300">Action</th>
            </tr>
            <tr class="even:bg-yellow-50 odd:bg-blue-300">
                <td class=" px-4 py-2">Kawtar</td>
                <td class=" px-4 py-2">Kawtar</td>
                <td class=" px-4 py-2">Kawtar</td>
                <td class=" px-4 py-2">Kawtar</td>
                <td class=" px-4 py-2">Kawtar</td>
