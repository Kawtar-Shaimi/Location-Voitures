<?php
    ...
    $contrat_infos = $_SESSION['contrat_infos'] ?? null;
        ...
        <fieldset class="flex justify-center items-center w-4/5">
            <div class="w-[90%] lg:max-w-[50%]">
                ...
                <form class="flex flex-col justify-center pl-10 bg-blue-900 h-[550px] rounded-md shadow-xl" action="../../Controllers/Contrats/updateContrat.php" method="post">
                    ...
                    <input class="w-[80%] bg-yellow-50 rounded focus:outline-none focus:border-transparent" type="date" name="DateFin" value="<?php if($contrat_infos) echo $contrat_infos['DateFin']; ?>"><br>
                    <?php if ($dateFinErr) echo "<p class='text-red-600'>$dateFinErr</p><br>"?>
                    <label class="text-yellow-100">Durée :</label>
                    <input class="w-[80%] bg-yellow-50 rounded focus:outline-none focus:border-transparent" type="number" name="Duree" value="<?php if($contrat_infos) echo $contrat_infos['Duree']; ?>"><br>
                    <?php if ($dureeErr) echo "<p class='text-red-600'>$dureeErr</p><br>"?>
                    <label class="text-yellow-100">Numéro client :</label>
                    <input class="w-[80%] bg-yellow-50 rounded focus:outline-none focus:border-transparent" type="number" name="num_client" value="<?php if($contrat_infos) echo $contrat_infos['num_client']; ?>"><br>
                    <label class="text-yellow-100">Numéro Immatriculation :</label>
                    <input class="w-[80%] bg-yellow-50 rounded focus:outline-none focus:border-transparent" type="text" name="NumImmatriculation" value="<?php if($contrat_infos) echo $contrat_infos['NumImmatriculation']; ?>"><br>
