        ...
        <div class="flex relative">
            ...
            <div class="w-4/5 bg-cover bg-center" style="background-image: url('../../imgs/c.jpg');">
                ...
                <div class="mt-10 ms-5">
                    <button class="bg-blue-900 px-5 py-3 text-yellow-100 rounded"><a href="./ajouterContrat.php">Ajouter Contrat</a></button>
                </div>
                <div class="clients w-full pr-5 top-4 ps-5">
                    <p class="text-center pb-2 font-bold text-blue-900 text-3xl">Liste des contrats</p>
