<?php
    ...
    $client_infos = $_SESSION['client_infos'] ?? null;
        ...
        <fieldset class="flex justify-center items-center w-4/5">
            <div class="w-[70%] lg:max-w-[50%]">
                ...
                <form class="flex flex-col justify-center pl-10 bg-blue-900 h-96 rounded-md shadow-xl" action="../../Controllers/Clients/updateClient.php" method="post">
                    ...
                    <input class="w-[80%] bg-yellow-50 rounded focus:outline-none focus:border-transparent" type="text" name="adresse" value="<?php if($client_infos) echo $client_infos['adresse']; ?>"><br>
                    <?php if ($addressErr) echo "<p class='text-red-600'>$addressErr</p><br>"?>
                    <label class="text-yellow-100">Téléphone :</label>
                    <input class="w-[80%] bg-yellow-50 rounded focus:outline-none focus:border-transparent" type="tel" name="tel" value="<?php if($client_infos) echo $client_infos['tel']; ?>"><br>
