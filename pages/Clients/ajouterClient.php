...
<head>
    ...
    <div class="sidebar bg-blue-900 w-full lg:w-1/5 lg:h-screen text-center rounded flex lg:flex-col gap-2 lg:gap-7 lg:flex-wrap justify-around lg:justify-start items-center">
            ...
            <div class="w-full min-h-[90vh] bg-FormBg bg-cover bg-center flex justify-center items-center bg-no-repeat" style="background-image: url('../../imgs/c.jpg');">
            <fieldset class="flex justify-center items-center w-4/5">
                <div class="w-[90%] lg:w-[50%]" >
                    ...
                    <form class="flex flex-col justify-center pl-10 bg-blue-900 h-96 rounded-md shadow-xl" action="../../Controllers/Clients/ajouterClient.php" method="post">
                        ...
                        <?php if ($addressErr) echo "<p class='text-red-600 text-sm lg:text-[15px]'>$addressErr</p><br>"?>
                        ...
                        <?php if ($phoneErr) echo "<p class='text-red-600 text-sm lg:text-[15px]'>$phoneErr</p><br>"?>
